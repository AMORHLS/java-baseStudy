...
<body>
<form name ="dataFrm" id="dataFrm" action="<%=request.getContextPath() %>/servlet/AddServlet" method="post" enctype="multipart/form-data">
	<table  width="100%" border="0" cellspacing="5" cellpadding="0">
		...
		<tbody>
			...
			<tr>
				...
				<td style="text-align:left;"><textarea id="summary" name="summary" rows="8" cols="50" class="ckeditor"></textarea></td>
			</tr>
			<tr>
